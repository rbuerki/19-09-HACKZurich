...
response = requests.post('https://sso-int.sbb.ch/auth/realms/SBB_Public/protocol/openid-connect/token',
                         data=data)
...
# BUG! This vars are somehow needed to have the app running - should not ...
# because the variables should be passed from offers function in application.py
